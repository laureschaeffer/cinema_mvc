...
<section class="formulaire">
    <form action="index.php?action=ajouterModifAct&id=<?=$acteurs["id_personne"]?>" method="post" enctype="multipart/form-data">
        ...
        <input type="date" name="anniversaire" value="<?=$acteurs["date_naissance"]?>">
        <p><label>Biographie</label></p>
        <textarea name="biographie" rows="4" cols="40"><?=$acteurs["biographie"]?></textarea>
...
$titre_secondaire = "Modifier l'acteur ".$acteurs['prenom']." ".$acteurs['nom'];
